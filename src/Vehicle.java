...
public class Vehicle {
	...
	private ArrayList<SaleableObject> ArrofSaleableObjects = new ArrayList<SaleableObject>(
			capacity);
	...
	public void printVehicleContents() {
		for (int i = 0; i < ArrofSaleableObjects.size(); i++) {
			System.out
					.println("nama: " + ArrofSaleableObjects.get(i).getName());
			System.out.println("harga: "
					+ ArrofSaleableObjects.get(i).getPrice());
			System.out.println("kapasitas: "
					+ ArrofSaleableObjects.get(i).getCapacity());
			System.out.println();
		}
	}
