...
public class Vehicle
{
	...
	private ArrayList<SaleableObject> ArrofSaleableObject = new ArrayList<SaleableObject>(capacity);
	...
	public void printVehicleContents() {
		for(int i = 0; i < ArrofSaleableObject.size(); i++)
		{
			System.out.println("nama: " + ArrofSaleableObject.get(i).getName());
			System.out.println("harga: " + ArrofSaleableObject.get(i).getPrice());
			System.out.println("kapasitas: " + ArrofSaleableObject.get(i).getCapacity());
			System.out.println();
		}
	}

	public void emptyAll() {
		ArrofSaleableObject.removeAll(ArrofSaleableObject);
	}
	...
	public int saleAll() {
		...
		for(int i = 0; i < ArrofSaleableObject.size(); i++)
		{
			sumMoney += ArrofSaleableObject.get(i).getPrice();
		}
		emptyAll();
		return sumMoney;
	}
